			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="blog-inner">
						...
						<div class="item-meta">
							<a href="#"><i class="fa fa-comments-o"></i> {{$doctor->doctor_name}} </a>
							<a href="#"><i class="fa fa-user-o"></i> {{$doctor->doctor_speciality}}</a>
							<span class="dti">{{$doctor->created_at}}</span>
						</div>
