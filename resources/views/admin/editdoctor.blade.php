        ...
        <div class="card-body">
          ...
          <table class="table table-hover table-striped">
            <tr>
              ...
              <th>Docotr Chamber</th>
              <th>Docotr Contact</th>
            ...
            @foreach ($doctor as $doctor)
              <tr>
                ...
                <td>{{$doctor->doctor_chember}}</td>
                <td>{{$doctor->doctor_contact}}</td>
                <td>{{$doctor->doctor_location}}</td>
                <td><a href="{{ route('showdoctor', $doctor->id) }}" class="btn btn-success">Edit</a>
