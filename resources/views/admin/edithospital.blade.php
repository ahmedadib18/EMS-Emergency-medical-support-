          ...
          <table class="table table-hover table-striped">
            ...
            @foreach ($hospital as $hospital)
              <tr>
                ...
                <td>{{$hospital->hospital_departments}}</td>
                <td>{{$hospital->hospital_contact}}</td>
                <td>{{$hospital->hospital_icu}}</td>
                <td><a href="{{route('foysalhospital', $hospital->id) }}" class="btn btn-success">Edit</a>
               
               
                          <form action="{!! route('foysalhospitaldel', $hospital->id) !!}"  method="post">
                            {{ csrf_field() }}
