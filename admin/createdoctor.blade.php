...
<head>
  ...
  <title>EMS-Admin-Doctor CRUD</title>
  <!-- plugins:css -->
...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="doctor_name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="title">
   
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Doctor Chamber</label>
    <input type="text" class="form-control" name="doctor_chember" id="exampleInputPassword1" placeholder="Chamber">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Doctor Location</label>
    <input type="text" class="form-control" name="doctor_location" id="exampleInputPassword1" placeholder="Location">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Doctor Speciality</label>
    <input type="text" class="form-control" name="doctor_speciality" id="exampleInputPassword1" placeholder="Speciality">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Doctor Contact</label>
    <input type="text" class="form-control" name="doctor_contact" id="exampleInputPassword1" placeholder="contact">
  </div>
  
 <div class="form-group">
   <label for="hospital_image">Doctor Image</label>
    <input type="file" class="form-control" name="doctor_image" id="exampleInputPassword1" placeholder="">
  </div>
