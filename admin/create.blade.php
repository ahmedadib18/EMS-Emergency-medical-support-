    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link" href="{{route('admincreate')}}"><img class="menu-icon" src="/images/menu_icons/01.png" ><span class="menu-title">HOSPITAL CRUD</span></a></li>
          <li class="nav-item"><a class="nav-link" href="{{route('admincreatedoctor')}}"><img class="menu-icon" src="/images/menu_icons/01.png" ><span class="menu-title">Doctor CRUD</span></a></li>
          <li class="nav-item"><a class="nav-link" href="{{route('admincreateambulance')}}"><img class="menu-icon" src="/images/menu_icons/01.png" ><span class="menu-title">Ambulance CRUD</span></a></li>
          
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{route('adib')}}" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="/images/menu_icons/08.png" > <span class="menu-title">Home Page</span><i class="menu-arrow"></i></a>
